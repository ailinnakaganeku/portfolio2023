        ...
        {!isMobile && (
          <div
            className={`absolute top-0 inset-x-0 flex justify-center items-end ${
              isHovered ? "" : "invisible"
            } dark:via-[#33333350] dark:to-transparent hover:dark:from-[#33333370] absolute bottom-0 left-0 right-0 rounded-b-lg p-2 bg-gradient-to-t from-[rgba(255,255,255,0.5)] via-[rgba(255,255,255,0.1)] to-transparent`}
          >
            <button
